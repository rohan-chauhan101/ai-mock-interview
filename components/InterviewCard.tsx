        ...
        <div className="card-border w-[360px] max-sm:w-full min-h-96">
            <div className="card-interview">
                <div>
                    ...
                    <h3 className="mt-5 capitalize"></h3>
                    ...
                    <p className="line-clamp-2 mt-5"></p>
                    {feedback?.finalAssessment || "You haven't given the interview yet please take it now to practice and improve your skills."}
                </div>
